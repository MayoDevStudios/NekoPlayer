...
namespace NekoPlayer.App.Graphics.Shaders.New.Bloom
{
    ...
    {
        private class BloomContainerDrawNode : ShaderDrawNode<VideoNewShaderContainer>
        {
            ...
            public BloomContainerDrawNode(VideoNewShaderContainer source, BufferedDrawNodeSharedData sharedData)
