...
namespace NekoPlayer.App.Graphics.Shaders.New.Grayscale
{
    ...
    {
        private class GrayscaleDrawNode : ShaderDrawNode<GrayscaleContainer>
        {
            private float strength;
            private IUniformBuffer<GreyscaleParameters> parametersBuffer;

            public GrayscaleDrawNode(VideoNewShaderContainer source, BufferedDrawNodeSharedData sharedData)
