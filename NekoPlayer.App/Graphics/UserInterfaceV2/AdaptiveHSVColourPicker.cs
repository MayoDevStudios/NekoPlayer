...
namespace NekoPlayer.App.Graphics.UserInterfaceV2
{
    public partial class AdaptiveHSVColourPicker : HSVColourPicker
    {
        ...
        protected override HueSelector CreateHueSelector() => new AdaptiveHueSelector();
        ...
        private partial class AdaptiveHueSelector : HueSelector
        {
            public AdaptiveHueSelector()
            {
            ...
            private partial class SliderNub : CompositeDrawable
            {
                ...
                public SliderNub(AdaptiveHueSelector osuHueSelector)
                {
